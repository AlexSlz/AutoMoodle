...
namespace autoMoodle
{
    public partial class Form1 : Form
    {
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        countReload++;
                        Browser.Navigate().GoToUrl("http://moodle.dgma.donetsk.ua/course/view.php?id=664");
                        List<IWebElement> list = Browser.FindElements(By.XPath("//div[@class='activityinstance']/a")).ToList();
        ...
        {
            Process.Start("https://t.me/LexLtr");
        }
